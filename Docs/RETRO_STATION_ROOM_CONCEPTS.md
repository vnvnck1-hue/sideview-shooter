...
> 2026-09-22 후속 배경 방향은 [BACKGROUND_ART_DIRECTION](BACKGROUND_ART_DIRECTION.md)을 따른다. 이 문서의 두 원화와 조사 맥락은 보존하되, 외부 암부 여백·옛 방 점유율을 이후 모든 방의 고정 구도로 적용하지 않는다. 새 방향은 얕은 측면 공간과 고유색을 보존하는 상호작용 위계이며, 이 안내만으로 기존 원화를 변경하지 않는다.
